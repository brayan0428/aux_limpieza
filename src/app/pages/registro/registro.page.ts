...
export class RegistroPage implements OnInit {
  ...
  async guardarUsuario(form){
    ...
    if(form.acepta_terminos == false){
      this.toast.mostrarNotificacion('Debe aceptar los terminos y condiciones',2000)
      return
    }
    form.perfil = 1
    console.log(form)
  ...
  abrirTerminos(){
    let downloadUrl = 'https://auxlimpieza.com/wp-content/uploads/2019/11/terminos-y-condiciones-app.pdf'
